...
(function($){
	...
	SEMICOLON.initialize = {
		...
		LogoIntro: function(){
			/*var elementMobile = $LogoIntroEl.attr('data-mobile'),
				elementOffset = $LogoIntroEl.attr('data-offset');

			if( !elementOffset ) { elementOffset = 50; }

			if( elementMobile != 'true' && ( $body.hasClass('device-sm') || $body.hasClass('device-xs') ) ) { return true; }*/

			if( $window.scrollTop() < 50 ) {
				$LogoIntroEl.fadeIn();
				$body.addClass('logo-intro-active');
			} else {
				$LogoIntroEl.fadeOut();
				$body.removeClass('logo-intro-active');
			}
		},
	...
	SEMICOLON.documentOnReady = {
		...
		windowscroll: function(){
			...
			$window.on( 'scroll', function(){
				...
				SEMICOLON.initialize.LogoIntro();
